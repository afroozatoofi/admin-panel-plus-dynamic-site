...
<script type="text/javascript" >
    ...
    $(document).ready(function(){                
        restUrl = '<?php echo Router::url('/Gallery/', true) ?>';
        columns = [           
    ...
    function save(e, url) {
		...
		e = $(e.target).serialize()+"&data[Gallery][image]="+(image ? image : "");		
	    $.ajax({
	        url: restUrl + url,
	        type: "post",
	        dataType: "json",        
    ...
    function setImage(name){
		if(name){
			$img = $('<img />').attr('data-name', name).attr('src', '<?php echo $this->webroot; ?>img/gallery/thumb/' + name);                
        	$('#images').html($img);
        }
	}
    $(function() {        
...
<form role="form" style="direction:rtl;" id="Form">      
    <input id="id" name="data[Gallery][id]" type="hidden" value="" >          
    <table style="width:700px">
        ...
        <tr>      
        	<td>
                ...
                <div class="col-xs-8">     
                    <textarea name="data[Gallery][title]" rows="3" class="form-control" ></textarea>          
                </div>
            </td>                              
        </tr>
        <tr>            
            <td>
                ...
                <div class="col-xs-8">     
                    <input id="image" name="image" class="form-control" type="file" data-url="<?php echo Router::url('/Gallery/', true) ?>uploadImage" >                    
        ...
        <tr>
        	<td>
                ...
                <div class="col-xs-8" style="text-align:right">                         
                    <div class="checkbox">
                        <label>
                            <input id="isEnabled" checked="checked" name="data[Gallery][isEnabled]" type="checkbox" value="1" >
                        </label>
                    </div>
                </div>
            </td>     
