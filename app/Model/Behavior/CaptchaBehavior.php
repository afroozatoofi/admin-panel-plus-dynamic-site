...
class CaptchaBehavior extends ModelBehavior {
	...
	public function setup(Model $model, $config = array()) {
		...
		$this->_config [$model->alias] = array_merge ( $this->_config [$model->alias], ( array ) $config );
	...
	public function beforeValidate(Model $model, $options = Array()) {
		...
		$fields = array ();
		$fields = is_array ( $original_fields ) ? $original_fields : array (
				$original_fields 
		);
	 ...
	 *        	The model reference
	 * @param array $check
	 *        	The array containing captcha field value
	 * @access public
