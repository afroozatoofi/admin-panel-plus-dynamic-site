...
class ImageComponent extends Component {
	...
	public function __construct() {
		...
		$this->Waterdropfx = array (
				0,
				1.2,
				400,
				40 
		);
		$this->Maketransparent = array (
				0,
				0,
				'#FFFFFF',
				30 
		...
		$this->Displacementmapthumb = array (
				0,
				'',
				0,
				0,
	...
	private function filter() {
		if (function_exists ( 'imageconvolution' )) {
			imageconvolution ( $this->im, array (
					array (
							$this->Filter [0],
							$this->Filter [1],
							$this->Filter [2] 
	 ...
	 *        	string source image
	 * @param
	 *        	string exif data in binary format
	 */
